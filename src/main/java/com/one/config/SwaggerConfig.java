...
@OpenAPIDefinition(info = @Info(title = "E-commerce API", version = "1.0.0", description = "This is the E-commerce API is for internal use",
		...
		contact = @Contact(name = "One Aim Pvt. Ltd.", url = "http://www.oneaim.com/", email = "mailto:info@oneaim.com"), license = @License(name = "Copyright Aim One. All Rights Reserved", url = "https://www.Aim Pvt.com/")), servers = {
